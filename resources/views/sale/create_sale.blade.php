        ...
        <div class="main-menu">
          ...
          ?>
              ...
              ?>
                        ...
                        @endif
                        @endif
                        @if(FALSE && $print_barcode_active)
                        <li id="printBarcode-menu"><a
                                href="{{route('product.printBarcode')}}">{{__('file.print_barcode')}}</a></li>
                        @endif
                        @if(FALSE && $adjustment_active)
                        <li id="adjustment-list-menu"><a href="{{route('adjustment.index')}}">{{trans('file.Adjustment
                                List')}}</a></li>
                        <li id="adjustment-create-menu"><a href="{{route('adjustment.create')}}">{{trans('file.Add
                                Adjustment')}}</a></li>
                        @endif
                        @if(FALSE && $stock_count_active)
          ...
          ?>
              ...
              ?>
                        ...
                        {{-- <li id="sale-create-menu"><a href="{{route('sales.create')}}">{{trans('file.Add
                                Sale')}}</a></li> --}}
                        {{-- <li id="sale-import-menu"><a href="{{url('sales/sale_by_csv')}}">{{trans('file.Import Sale
                                By CSV')}}</a></li> --}}
                        @endif
                        @endif
                        ...
                        @endif
                        {{-- <li id="delivery-menu"><a href="{{route('delivery.index')}}">{{trans('file.Delivery
                                List')}}</a></li> --}}
                    </ul>
                </li>
                <?php
          ...
          ?>
              ...
              ?>
                        @if($add_permission_active)
                        <li id="biller-create-menu"><a href="{{route('biller.create')}}">{{trans('file.Add
                                Biller')}}</a></li>
                        @endif
                        @endif
                        <?php
            ...
            ?>
                    <ul id="report" class="collapse list-unstyled ">
                        ...
                        <li id="daily-purchase-report-menu">
                            <a href="{{url('report/daily_purchase/'.date('Y').'/'.date('m'))}}">{{trans('file.Daily
                                Purchase')}}</a>
                        </li>
                        @endif
                ...
                <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Total')}}</span><span
                                                id="subtotal">{{number_format((float)$lims_sale_data->total_price, 2,
                                                '.', '')}}</span>
                                        </div>
                                        <div class="col-sm-4">
                    ...
                    <div class="payment-amount">
                        <h2>{{trans('file.grand total')}} <span
                                id="grand-total">{{number_format((float)$lims_sale_data->grand_total, 2, '.',
                                '')}}</span></h2>
                    </div>
                        ...
                        <div class="container-fluid">
                            ...
                            ?>
                                        ...
                                        <li class="nav-item"><a class="dropdown-item" href="{{route('setting.pos')}}"><i
                                                    class="dripicons-gear"></i> <span>{{trans('file.POS
                                                    Setting')}}</span></a> </li>
                                        @endif
                                        @if($alert_product > 0)
                                        <li class="nav-item">
