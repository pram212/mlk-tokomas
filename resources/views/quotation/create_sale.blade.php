                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="discount">{{ $product_quotation->discount }}</td>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="order_discountid" name="order_discount" class="form-control" value="{{$lims_quotation_data->order_discount}}" step="any"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="shipping_costid" name="shipping_cost" class="form-control" value="{{$lims_quotation_data->shipping_cost}}" step="any"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
$('input[name="paid_amount"]').on("input", function() {
    ...
    $("#change").text( parseInt(($("#paying-amount").val().replaceAll('.', '') == '' ? 0 : $("#paying-amount").val().replaceAll('.', '')) - ($(this).val().replaceAll('.', '') == '' ? 0 : $(this).val().replaceAll('.', '') )) );
    var id = $('select[name="paid_by_id"]').val();
    if(id == 2){
...
$('input[name="paying_amount"]').on("input", function() {
    $("#change").text( parseInt( ($(this).val().replaceAll('.', '') == '' ? 0 : $(this).val().replaceAll('.', '')) - parseInt($('input[name="paid_amount"]').val().replaceAll('.', ''))));
});
