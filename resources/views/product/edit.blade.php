                        ...
                        <div class="card-body">
                            <p class="italic">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name"
                                                aria-describedby="name" required value="{{ $product->name }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ trans('file.sub category') }} *</strong> </label>
                                            <div class="input-group">
                                                <input type="text" placeholder="-" class="form-control"
                                                    value="{{ $product->category->sub_category }}">
                                            </div>
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="treat_recomendation"
                                                value="{{ $product->treat_recomendation }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="recomendation_after"
                                                value="{{ $product->recomendation_after }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">{{ trans('file.Product Image') }}</label>
                                                </div>
                                                <img src="{{ asset($product->image) }}" alt="" width="" height="100">
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
