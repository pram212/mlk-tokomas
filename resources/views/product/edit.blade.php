                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="code" class="form-control" id="code" aria-describedby="code" value="{{$product->code}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="discount" id="input-diskon" value="{{$product->discount}}">
                                                    @error('discount')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="mg" class="mg" id="input-mg" value="{{$product->mg}}">
                                                    @error('mg')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="price" name="price" class="form-control" step="any" value="{{ $product->price }}">
                                                    @error('price')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="product_property_id" class="form-control" id="input-kd-sifat">
                                                        <option value="">{{ __('file.Select') }}
                                                        </option>
                                            ...
                                            <div class="col-md-10">
                                                <div class="row" id="product-preview" style="background-color: {{ @$product->tagType->color }}">
                                                    <div class="col-md-6">
