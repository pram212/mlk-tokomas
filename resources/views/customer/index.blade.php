...
<div class="alert alert-success alert-dismissible text-center"><button type="button" class="close" data-dismiss="alert"
        aria-label="Close"><span aria-hidden="true">&times;</span></button>{!! session()->get('create_message') !!}
</div>
@endif
...
<div class="alert alert-success alert-dismissible text-center"><button type="button" class="close" data-dismiss="alert"
        aria-label="Close"><span aria-hidden="true">&times;</span></button>{!! session()->get('import_message') !!}
</div>
@endif
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="button" data-id="{{$customer->id}}" class="deposit btn btn-link"
                                        data-toggle="modal" data-target="#depositModal"><i class="dripicons-plus"></i>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="amountidid" name="amount" step="any" class="form-control" required>
                </div>
                <div class="form-group">
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>{{trans('file.Amount')}} *</label>
                    <input type="text" id="amounteditid" name="amount" step="any" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>{{trans('file.Note')}}</label>
                    <textarea name="note" rows="4" class="form-control"></textarea>
...
<script type="text/javascript">
  ...
  $(".getDeposit").on("click", function() {
        ...
        $.get('customer/getDeposit/' + id, function(data) {
            ...
            $.each(data[0], function(index){
                ...
                cols += '<td>' + formatRupiah(data[2][index]) + '</td>';
                if(data[3][index])
  ...
  if(all_permission.indexOf("customers-delete") == -1)
    ...
    var amounteditid = document.getElementById('amounteditid');
    amounteditid.addEventListener('keyup', function(e){
        amounteditid.value = formatRupiah(this.value, 'input');
    });
    amounteditid.addEventListener('mouseover', function(e){
        amounteditid.value = formatRupiah(this.value, 'input');
    });
