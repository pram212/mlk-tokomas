...
<section>
    <div class="container-fluid">
        ...
        <a href="{{route('return-purchase.create')}}" class="btn btn-info"><i class="dripicons-plus"></i>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="{{ route('return-purchase.edit', $return->id) }}" class="btn btn-link"><i
                                            class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                </li>
                                @endif
                                <li class="divider"></li>
                                @if(in_array("purchase-return-delete", $all_permission))
                                {{ Form::open(['route' => ['return-purchase.destroy', $return->id], 'method' =>
                                'DELETE'] ) }}
                                <li>
                ...
                <div class="container mt-3 pb-2 border-bottom">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            {{ Form::open(['route' => 'return-purchase.sendmail', 'method' => 'post', 'class' =>
                            'sendmail-form'] ) }}
...
<script type="text/javascript">
    ...
    function returnDetails(returns){
        ...
        $.get('return-purchase/product_return/' + returns[11], function(data){
            ...
            cols += '<td>' + formatRupiah(returns[12]) + '</td>';
            cols += '<td>' + formatRupiah(returns[13]) + '</td>';
            cols += '<td>' + formatRupiah(returns[14]) + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            cols += '<td>' + formatRupiah(returns[15]) + '(' + returns[16] + '%)' + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            cols += '<td>' + formatRupiah(returns[17]) + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
