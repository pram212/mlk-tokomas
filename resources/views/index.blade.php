        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="wrapper count-title text-center">
              ...
              <div class="count-number revenue-data">{{number_format($revenue,0, ',' , '.')}}</div>
            </div>
          </div>
          <!-- Count item widget-->
          <div class="col-sm-3">
            <div class="wrapper count-title text-center">
              ...
              <div class="count-number return-data">{{number_format($return,0, ',' , '.')}}</div>
            </div>
          </div>
          <!-- Count item widget-->
          <div class="col-sm-3">
            <div class="wrapper count-title text-center">
              ...
              <div class="count-number purchase_return-data">{{number_format($purchase_return,0, ',' , '.')}}</div>
            </div>
          </div>
          <!-- Count item widget-->
          <div class="col-sm-3">
            <div class="wrapper count-title text-center">
              ...
              <div class="count-number profit-data">{{number_format($profit,0, ',' , '.')}}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card line-chart-example">
          ...
          <div class="card-body">
            ...
            <canvas id="cashFlow" data-color="{{$color}}" data-color_rgba="{{$color_rgba}}"
              data-recieved="{{json_encode($payment_recieved)}}" data-sent="{{json_encode($payment_sent)}}"
              data-month="{{json_encode($month)}}" data-label1="{{trans('file.Payment Recieved')}}"
        ...
        <div class="card">
          ...
          <div class="pie-chart mb-2">
            <canvas id="transactionChart" data-color="{{$color}}" data-color_rgba="{{$color_rgba}}"
              data-revenue={{$revenue}} data-purchase={{$purchase}} data-expense={{$expense}}
