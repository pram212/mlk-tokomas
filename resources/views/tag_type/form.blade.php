                ...
                <form action="{{ $action }}" class="row" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="code" class="form-control" id="code" aria-describedby="code" required value="{{ old('code', @$tagType->code ) }}">
                            @error('code')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Kode Warna*</strong> </label>
                            <input type="color" name="color" class="form-control" id="color" aria-describedby="color" required  value="{{ old('color', @$tagType->color ) }}" >
                            @error('color')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea  name="description" class="form-control" id="description" aria-describedby="description" required>{{ old('description', @$tagType->description ) }}</textarea>
                            @error('description')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
