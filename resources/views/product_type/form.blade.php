        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @php
                        $action = @$productType ? route('product-categories.producttype.update', @$productType->id) : route('product-categories.producttype.store');
                    @endphp
                    <form action="{{ $action }}" class="row" method="POST">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="description">{{ old('description', @$productType->description) }}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
