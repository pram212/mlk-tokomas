        ...
        <div class="form-inner">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-12">
                  <img src="{{ asset('public/logo/bima_text_1.png') }}" width="302px">
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-md-12">
                  <img src="{{ asset('public/logo/bima_logo_1.png') }}" width="233px">
                </div>
              </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                  ...
                  <form method="POST" action="{{ route('login') }}" id="login-form"
                    ...
                    <div class="form-group text-left">
                      <label for="login-username" class="label-material small">{{trans('file.UserName')}}</label>
                    ...
                    <div class="form-group text-left">
                      <label for="login-password" class="label-material small">{{trans('file.Password')}}</label>
                      <div class="input-group flex-nowrap">
