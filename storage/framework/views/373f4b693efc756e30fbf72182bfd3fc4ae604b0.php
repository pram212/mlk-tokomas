 <?php $__env->startSection('content'); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><?php echo e(trans('file.To display Image it must be stored in')); ?> public/images/product
                        <?php echo e(trans('file.directory')); ?>. <?php echo e(trans('file.Image name must be same as product name')); ?></p>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <script>
        ...
        function productDetails(product, imagedata) {
            ...
            htmltext = '<p><strong><?php echo e(trans('file.Type')); ?>: </strong>' + product[0] +
                '</p><p><strong><?php echo e(trans('file.name')); ?>: </strong>' + product[1] +
                '</p><p><strong><?php echo e(trans('file.Code')); ?>: </strong>' + product[2] +
                '</p><p><strong><?php echo e(trans('file.Brand')); ?>: </strong>' + product[3] +
                '</p><p><strong><?php echo e(trans('file.category')); ?>: </strong>' + product[4] +
                '</p><p><strong><?php echo e(trans('file.Quantity')); ?>: </strong>' + product[16] +
                '</p><p><strong><?php echo e(trans('file.Unit')); ?>: </strong>' + product[5] +
                '</p><p><strong><?php echo e(trans('file.Cost')); ?>: </strong>Rp ' + this.formatRupiah(product[6]) +
                '</p><p><strong><?php echo e(trans('file.Price')); ?>: </strong>Rp ' + this.formatRupiah(product[7], '') +
                '</p><p><strong><?php echo e(trans('file.Tax')); ?>: </strong>' + product[8] +
                '</p><p><strong><?php echo e(trans('file.Tax Method')); ?> : </strong>' + product[9] +
                '</p><p><strong><?php echo e(trans('file.Alert Quantity')); ?> : </strong>' + product[10] +
                '</p><p><strong><?php echo e(trans('file.Product Details')); ?>: </strong></p>' + product[11];
            ...
            if (product[0] == 'combo') {
                ...
                var newRow = $("<tr>");
                newRow.append(
                    '<th><?php echo e(trans('file.product')); ?></th><th><?php echo e(trans('file.Quantity')); ?></th><th><?php echo e(trans('file.Price')); ?></th>'
                );
                ...
                $.get('products/product_warehouse/' + product[12], function(data) {
                    if (data.product_warehouse[0].length != 0) {
                        ...
                        var newRow = $("<tr>");
                        newRow.append(
                            '<th><?php echo e(trans('file.Warehouse')); ?></th><th><?php echo e(trans('file.Quantity')); ?></th>');
                        newHead.append(newRow);
                    ...
                    if (data.product_variant_warehouse[0].length != 0) {
                        ...
                        var newRow = $("<tr>");
                        newRow.append(
                            '<th><?php echo e(trans('file.Warehouse')); ?></th><th><?php echo e(trans('file.Variant')); ?></th><th><?php echo e(trans('file.Quantity')); ?></th>'
                        );
                        newHead.append(newRow);
                        $.each(warehouse, function(index) {
                            var newRow = $("<tr>");
        ...
        $(document).ready(function() {
            var table = $('#product-data-table').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: '<?php echo url('products/product-datatable'); ?>',
                    dataType: "json",
                    type: "get"
                },
                "columns": [{
            ...
            $('#product-data-table tbody').on('click', 'a.btn-delete', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        type: "delete",
                        url: "<?php echo url('products'); ?>" + "/" + data.id,
                        dataType: "JSON",
                        statusCode: {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\mlk-tokomas\resources\views/product/index.blade.php ENDPATH**/ ?>