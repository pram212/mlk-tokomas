...
<script type="text/javascript">
    ...
    $("#create-modal select[name='type']").on("change", function() {
      if ($(this).val() == 'fixed') {
          ...
          $("#create-modal .icon-text").text('Rp');
      } 
      else {
...
function confirmDelete() {
    ...
    var minimum_amountid = document.getElementById('minimum_amountid');
    minimum_amountid.addEventListener('keyup', function(e){
        minimum_amountid.value = formatRupiah(this.value, 'input');
    });
    minimum_amountid.addEventListener('mouseover', function(e){
        minimum_amountid.value = formatRupiah(this.value, 'input');
    });
    ...
    var minimum_amountidupdate = document.getElementById('minimum_amountidupdate');
    minimum_amountidupdate.addEventListener('keyup', function(e){
        minimum_amountidupdate.value = formatRupiah(this.value, 'input');
    });
    minimum_amountidupdate.addEventListener('mouseover', function(e){
        minimum_amountidupdate.value = formatRupiah(this.value, 'input');
    });

    var amountidupdate = document.getElementById('amountidupdate');
    amountidupdate.addEventListener('keyup', function(e){
        amountidupdate.value = formatRupiah(this.value, 'input');
    });
    amountidupdate.addEventListener('mouseover', function(e){
        amountidupdate.value = formatRupiah(this.value, 'input');
    }); 
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\mlk-tokomas\resources\views/coupon/index.blade.php ENDPATH**/ ?>