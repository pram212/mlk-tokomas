            ...
            <div class="col-md-6">
                <div class="card">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Discount')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount-modal"> <i class="dripicons-document-edit"></i></button></span><span id="discount">0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Coupon')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#coupon-modal"><i class="dripicons-document-edit"></i></button></span><span id="coupon-text">0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Tax')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></span><span id="tax">0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Shipping')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span><span id="shipping-cost">0</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payment-amount">
                        <h2><?php echo e(trans('file.grand total')); ?> <span id="grand-total">0</span></h2>
                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <input type="text" id="paying_amountid" name="paying_amount" class="form-control numkey" required step="any">
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <label><?php echo e(trans('file.Paying Amount')); ?> *</label>
                                            <input type="text" id="paid_amountid" name="paid_amount" class="form-control numkey"  step="any" readonly>
                                        </div>
                                        <div class="col-md-6 mt-1">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit_unit_priceid" name="edit_unit_price" class="form-control numkey" step="any">
                                </div>
                                <?php
                        $tax_name_all[] = 'No Tax';
                        $tax_rate_all[] = 0;
...
$(".payment-btn").on("click", function() {
    var audio = $("#mysoundclip2")[0];
    audio.play();
    $('input[name="paid_amount"]').val(parseInt($("#grand-total").text().replaceAll('.', '') == '' ? 0 : $("#grand-total").text().replaceAll('.', '') ));
    $('input[name="paying_amount"]').val(parseInt($("#grand-total").text().replaceAll('.', '') == '' ? 0 : $("#grand-total").text().replaceAll('.', '')  ));
    $("#change").text( 0 );
    $('.qc').data('initial', 1);
});
...
function addNewProduct(data){
    ...
    if(!data[11] && product_warehouse_price[pos]) {
        product_price.splice(rowindex, 0, parseInt(parseInt(product_warehouse_price[pos].replaceAll('.', '') == '' ? 0 : product_warehouse_price[pos].replaceAll('.', '')) * currency['exchange_rate']) + parseInt(product_warehouse_price[pos] * parseInt(currency['exchange_rate']) * parseInt(customer_group_rate ) ));
    }
    else {
        product_price.splice(rowindex, 0, parseInt(parseInt(data[2] ) * currency['exchange_rate']) + parseInt(parseInt(data[2] ) * currency['exchange_rate'] * parseInt(customer_group_rate )));
    }
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/sale/pos.blade.php ENDPATH**/ ?>