 <?php $__env->startSection('content'); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label for=""><?php echo e(trans('file.category')); ?></label>
                            <select name="category" id="category" class="form-control">
                                <option value="">Pilih</option>
                                <option value="1">Obat-obatan/Cream</option>
    ...
    <div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <?php echo e(Form::open(['route' => ['category.update', 1], 'method' => 'PUT', 'files' => true, 'id' => 'form-edit'])); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="">Sub Kategori</label>
                            <input type="text" class="form-control" id="edit-sub_category">
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".open-EditCategoryDialog", function() {
            ...
            $.get(url, function(data) {
                ...
                $("#form-edit").attr("action", "<?php echo url('category'); ?>" + "/" + data.id);
            });
        });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\mlk-tokomas\resources\views/category/create.blade.php ENDPATH**/ ?>