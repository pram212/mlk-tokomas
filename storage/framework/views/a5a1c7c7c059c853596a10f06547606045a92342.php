...
$('button[name="update_btn"]').on("click", function() {
    ...
    console.log("btn edit_discount =",edit_discount);
    console.log("btn edit_unit_price  =",parseInt(edit_unit_price));
...
function calculateRowProductData(quantity) {
    ...
    console.log("row_product_price=",product_price[rowindex]);
...
function unitConversion() {
    ...
    console.log("row_product_price unitConversion =",product_price[rowindex]);
    if (row_unit_operator == '*') {
        console.log("product_price[rowindex] unitConversion =",product_price[rowindex]);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/lubira.id/public_html/NaniaStore/resources/views/quotation/create.blade.php ENDPATH**/ ?>