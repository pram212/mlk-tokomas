                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_price"><?php echo e(number_format((float)$product_sale->net_unit_price,0, ',' , '.')); ?> </td>
                                                        <!-- <td class="discount"><?php echo e(number_format((float)$product_sale->discount,0, ',' , '.')); ?></td> -->
                                                        <td class="discount"><?php echo e($product_sale->discount); ?></td>
                                                        <td class="tax"><?php echo e(number_format((float)$product_sale->tax,0, ',' , '.')); ?></td>
                                                        <td class="sub-total"><?php echo e(number_format((float)$product_sale->total,0, ',' , '.')); ?></td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th></th>
                                                    <th id="total-discount"><?php echo e(number_format((float)$lims_sale_data->total_discount,0, ',' , '.')); ?></th>
                                                    <th id="total-tax"><?php echo e(number_format((float)$lims_sale_data->total_tax,0, ',' , '.')); ?></th>
                                                    <th id="total"><?php echo e(number_format((float)$lims_sale_data->total_price,0, ',' , '.')); ?></th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="order_discountid" name="order_discount" class="form-control" value="<?php echo e($lims_sale_data->order_discount); ?>" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="shipping_costid" name="shipping_cost" class="form-control" value="<?php echo e($lims_sale_data->shipping_cost); ?>" step="any" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p class="mt-2 pl-2"><strong id="coupon-text"><?php echo e(number_format((float)$lims_sale_data->coupon_discount,0, ',' , '.')); ?></strong></p>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <div class="col-md-4">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/sale/edit.blade.php ENDPATH**/ ?>