...
<script type="text/javascript">
    ...
    function datatable_sum(dt_selector, is_calling_first) {
        if (dt_selector.rows( '.selected' ).any() && is_calling_first) {
            ...
            $( dt_selector.column( 6 ).footer() ).html(formatRupiah(dt_selector.cells( rows, 6, { page: 'current' } ).data().sum()));
    ...
    function transferDetails(transfer) {
        ...
        $.get('transfers/product_transfer/' + transfer[3], function(data) {
            ...
            cols += '<td>' + formatRupiah(transfer[10]) + '</td>';
            cols += '<td>' + formatRupiah(transfer[11]) + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            cols += '<td>' + formatRupiah(transfer[12]) + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            cols += '<td>' + formatRupiah(transfer[13]) + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/transfer/index.blade.php ENDPATH**/ ?>