            ...
            <div class="modal-body">
                <?php echo Form::open(['route' => 'purchase.add-payment', 'method' => 'post', 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label><?php echo e(trans('file.Recieved AmountPurchase')); ?> *</label>
                            <input type="text" id="idpaying_amount" readonly  name="paying_amount" class="form-control numkey"  step="any" required>
                        </div>
                        <div class="col-md-6">
                            <label><?php echo e(trans('file.Paying AmountPurchase')); ?> *</label>
            ...
            <div class="modal-body">
                <?php echo Form::open(['route' => 'purchase.update-payment', 'method' => 'post', 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label><?php echo e(trans('file.Recieved AmountPurchase')); ?> *</label>
                            <input type="text" id="idedit_paying_amount" readonly  name="edit_paying_amount" class="form-control numkey"  step="any" required>
                        </div>
                        <div class="col-md-6">
                            <label><?php echo e(trans('file.Paying AmountPurchase')); ?> *</label>
                            <input type="text" id="idedit_amount" name="edit_amount" class="form-control"  step="any" required>
                        </div>
                        <div class="col-md-6 mt-1">
                            <label><?php echo e(trans('file.Change')); ?> : </label>
                            <p class="change ml-2">0</p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/purchase/index.blade.php ENDPATH**/ ?>