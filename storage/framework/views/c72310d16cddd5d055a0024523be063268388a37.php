...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.sub category')); ?> *</strong> </label>
                                            <div class="input-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Anjuran Treatment</label>
                                            <input type="text" class="form-control" name="treat_recomendation">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Done Time</label>
                                            <input type="text" class="form-control" name="done_time">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Jarak Waktu Treatment</label>
                                            <input type="text" class="form-control" name="treat_interval">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Step Treatment</label>
                                            <input type="text" class="form-control" name="treat_step">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Anjuran Setelah Tindakan</label>
                                            <input type="text" class="form-control" name="recomendation_after">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <i class="dripicons-question" data-toggle="tooltip" title="<?php echo e(trans('file.You can upload multiple image. Only .jpeg, .jpg, .png, .gif file can be uploaded. First image will be base image.')); ?>"></i>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\mlk-pos\resources\views/product/create.blade.php ENDPATH**/ ?>