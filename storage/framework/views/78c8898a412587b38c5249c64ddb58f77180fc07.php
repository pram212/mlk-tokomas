              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" step="any" id="amountidid" name="amount" class="form-control" required>
                    </div>
                    <div class="col-md-6 form-group">
            ...
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('file.Amount')); ?> *</label>
                        <input type="text" step="any" id="amountidid2" name="amount" class="form-control" required>
                    </div>
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('file.Method')); ?> *</label>
                        <select class="form-control selectpicker" name="paying_method" required>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $("#editModal input[name='amount']").val( formatRupiah($(this).data('amount')) );
    ...
    function datatable_sum(dt_selector, is_calling_first) {
        if (dt_selector.rows( '.selected' ).any() && is_calling_first) {
            ...
            const data = dt_selector.cells( rows, 5, { page: 'current' } ).data();
            var dataSum =0 ;
            for(var i=0; i < data.length; i++) {
                dataSum += Number(data[i].replaceAll('.', '') == '' ? 0 : data[i].replaceAll('.', ''));
            }
            $( dt_selector.column( 5 ).footer() ).html(formatRupiah(dataSum));
            ...
            var dataSum =0 ;
            for(var i=0; i < data.length; i++) {
                // datareplace.push(data[i].replaceAll('.', '') == '' ? 0 : data[i].replaceAll('.', ''));
                dataSum += Number(data[i].replaceAll('.', '') == '' ? 0 : data[i].replaceAll('.', ''));
            }
            $( dt_selector.column( 5 ).footer() ).html(formatRupiah(dataSum));
            // $( dt_selector.column( 5 ).footer() ).html(formatRupiah(dt_selector.cells( rows, 5, { page: 'current' } ).data().sum()));
    ...
    var amountidid = document.getElementById('amountidid');
    amountidid.addEventListener('keyup', function(e){
        amountidid.value = formatRupiah(this.value, 'input');
    });
    amountidid.addEventListener('mouseover', function(e){
        amountidid.value = formatRupiah(this.value, 'input');
    });

    var amountidid2 = document.getElementById('amountidid2');
    amountidid2.addEventListener('keyup', function(e){
        amountidid2.value = formatRupiah(this.value, 'input');
    });
    amountidid2.addEventListener('mouseover', function(e){
        amountidid2.value = formatRupiah(this.value, 'input');
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/payroll/index.blade.php ENDPATH**/ ?>