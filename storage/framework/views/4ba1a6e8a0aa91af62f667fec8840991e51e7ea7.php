                            ...
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="productcost" name="cost" value="<?php echo e($lims_product_data->cost); ?>" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="price" name="price" value="<?php echo e($lims_product_data->price); ?>" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    productcost.addEventListener('keyup', function(e){
        productcost.value = formatRupiah(this.value, 'input');
    });
    productcost.addEventListener('mouseover', function(e){
        productcost.value = formatRupiah(this.value, 'input');
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/product/edit.blade.php ENDPATH**/ ?>