...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#edit-btn').on('click', function() {
            ...
            $("#edit-money-transfer-modal input[name='amount']").val(formatRupiah($(this).data('amount')));
...
function confirmDelete() {
    ...
    var amountid3 = document.getElementById('amountid3');
    amountid3.addEventListener('keyup', function(e){
        amountid3.value = formatRupiah(this.value, 'input');
    });
    amountid3.addEventListener('mouseover', function(e){
        amountid3.value = formatRupiah(this.value, 'input');
    }); 

    var amountid2 = document.getElementById('amountid2');
    amountid2.addEventListener('keyup', function(e){
        amountid2.value = formatRupiah(this.value, 'input');
    });
    amountid2.addEventListener('mouseover', function(e){
        amountid2.value = formatRupiah(this.value, 'input');
    }); 
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/money_transfer/index.blade.php ENDPATH**/ ?>