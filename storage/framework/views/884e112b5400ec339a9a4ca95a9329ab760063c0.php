...
function confirmDelete() {
    ...
    var amountidedit = document.getElementById('amountidedit');
    amountidedit.addEventListener('keyup', function(e){
        amountidedit.value = formatRupiah(this.value, 'input');
    });
    amountidedit.addEventListener('mouseover', function(e){
        amountidedit.value = formatRupiah(this.value, 'input');
    });  
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/expense/index.blade.php ENDPATH**/ ?>