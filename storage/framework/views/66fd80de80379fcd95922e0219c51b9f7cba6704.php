						    ...
						    <tr>
						        ...
						        <td>
						        	<?php if($discount > 0): ?>
							      	...
							      	<span><?php echo e(number_format( $total[$key],0, ',' , '.')); ?></span><br>
							      	<?php endif; ?>
						        </td>
						        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						    </tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/report/monthly_sale.blade.php ENDPATH**/ ?>