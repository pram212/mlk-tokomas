              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number revenue-data"><?php echo e(number_format($revenue,0, ',' , '.')); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number return-data"><?php echo e(number_format($return,0, ',' , '.')); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number purchase_return-data"><?php echo e(number_format($purchase_return,0, ',' , '.')); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number profit-data"><?php echo e(number_format($profit,0, ',' , '.')); ?></div>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <?php endif; ?>
                              <td>Rp <?php echo e(number_format($sale->grand_total,0, ',' , '.')); ?></td>
                            </tr>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <?php endif; ?>
                              <td>Rp <?php echo e(number_format($purchase->grand_total,0, ',' , '.')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </tbody>
                        </table>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo e($key + 1); ?></td>
                          <td><?php echo e($product->name); ?><br>[<?php echo e($product->code); ?>]</td>
                          <td>Rp <?php echo e(number_format($sale->total_price,0, ',' , '.')); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tbody>
                    </table>
...
<script type="text/javascript">
    ...
    function dashboardFilter(data){
        $('.revenue-data').hide();
        $('.revenue-data').html(this.formatRupiah(data[0]));
        $('.revenue-data').show(500);

        $('.return-data').hide();
        $('.return-data').html(this.formatRupiah(data[1]));
        $('.return-data').show(500);

        $('.profit-data').hide();
        $('.profit-data').html(this.formatRupiah(data[2]));
        $('.profit-data').show(500);

        $('.purchase_return-data').hide();
        $('.purchase_return-data').html(this.formatRupiah(data[3]));
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/index.blade.php ENDPATH**/ ?>