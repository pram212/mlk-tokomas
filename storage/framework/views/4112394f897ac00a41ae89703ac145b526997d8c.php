              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => ['accounts.update', 1], 'method' => 'put']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="initial_balanceid" name="initial_balance" step="any" class="form-control">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $('.edit-btn').on('click', function() {
        ...
        $("#editModal input[name='initial_balance']").val(formatRupiah( $(this).data('initial_balance')) );
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/account/index.blade.php ENDPATH**/ ?>