...
<script type="text/javascript">
    ...
    function returnDetails(returns){
        ...
        $.get('return-sale/product_return/' + returns[13], function(data){
            ...
            cols += '<td>' + formatRupiah(returns[15]) + '</td>';
            cols += '<td>' + formatRupiah(returns[16]) + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            cols += '<td>' + formatRupiah(returns[17]) + '(' + returns[18] + '%)' + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            cols += '<td>' + formatRupiah(returns[19]) + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/salepro.id/public_html/Project_NaniaStore/resources/views/return/index.blade.php ENDPATH**/ ?>