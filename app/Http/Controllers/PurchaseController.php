...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //return dd($data);
        $data['total_qty'] = (str_replace('.', '', $data['total_qty']) == '' ? 0 : str_replace('.', '', $data['total_qty'])) ;   
        $data['total_discount'] = (str_replace('.', '', $data['total_discount']) == '' ? 0 : str_replace('.', '', $data['total_discount'])) ; 
        $data['total_cost'] = (str_replace('.', '', $data['total_cost']) == '' ? 0 : str_replace('.', '', $data['total_cost'])) ;    
        $data['total_tax'] = (str_replace('.', '', $data['total_tax']) == '' ? 0 : str_replace('.', '', $data['total_tax'])) ;   
        $data['order_tax'] = (str_replace('.', '', $data['order_tax']) == '' ? 0 : str_replace('.', '', $data['order_tax'])) ;    
        $data['order_discount'] = (str_replace('.', '', $data['order_discount']) == '' ? 0 : str_replace('.', '', $data['order_discount'])) ; 
        $data['shipping_cost'] = (str_replace('.', '', $data['shipping_cost']) == '' ? 0 : str_replace('.', '', $data['shipping_cost'])) ;   
        $data['grand_total'] = (str_replace('.', '', $data['grand_total']) == '' ? 0 : str_replace('.', '', $data['grand_total'])) ;  
        $data['order_tax_rate'] = (str_replace('.', '', $data['order_tax_rate']) == '' ? 0 : str_replace('.', '', $data['order_tax_rate'])) ;   
        ...
        $net_unit_cost = (str_replace('.', '', $data['net_unit_cost']) == '' ? 0 : str_replace('.', '', $data['net_unit_cost'])) ;
        $discount = (str_replace('.', '', $data['discount']) == '' ? 0 : str_replace('.', '', $data['discount'])) ; 
        $tax_rate = (str_replace('.', '', $data['tax_rate']) == '' ? 0 : str_replace('.', '', $data['tax_rate'])) ;   
        $tax = (str_replace('.', '', $data['tax']) == '' ? 0 : str_replace('.', '', $data['tax'])) ;     
        $total = (str_replace('.', '', $data['subtotal']) == '' ? 0 : str_replace('.', '', $data['subtotal'])) ;       
        $product_purchase = [];
        ...
        foreach ($product_id as $i => $id) {
            ...
            $product_purchase['net_unit_cost'] = (str_replace('.', '', $net_unit_cost[$i]) == '' ? 0 : str_replace('.', '', $net_unit_cost[$i]) );
            $product_purchase['discount'] = (str_replace('.', '', $discount[$i]) == '' ? 0 : str_replace('.', '', $discount[$i]) );
            $product_purchase['tax_rate'] = (str_replace('.', '', $tax_rate[$i]) == '' ? 0 : str_replace('.', '', $tax_rate[$i]) );
            $product_purchase['tax'] = (str_replace('.', '', $tax[$i]) == '' ? 0 : str_replace('.', '', $tax[$i]) );
            $product_purchase['total'] = (str_replace('.', '', $total[$i]) == '' ? 0 : str_replace('.', '', $total[$i]) );
    ...
    public function update(Request $request, $id)
    {
        ...
        $balance = (str_replace('.', '', $data['grand_total']) == '' ? 0 : str_replace('.', '', $data['grand_total']) ) - (str_replace('.', '', $data['paid_amount']) == '' ? 0 : str_replace('.', '', $data['paid_amount']) );
    ...
    public function addPayment(Request $request)
    {
        ...
        $lims_purchase_data->paid_amount += (str_replace('.', '', $data['amount']) == '' ? 0 : str_replace('.', '', $data['amount']));
        $balance = (str_replace('.', '', $lims_purchase_data->grand_total) == '' ? 0 : str_replace('.', '', $lims_purchase_data->grand_total)) - (str_replace('.', '', $lims_purchase_data->paid_amount) == '' ? 0 : str_replace('.', '', $lims_purchase_data->paid_amount) );
        ...
        $lims_payment_data->amount = (str_replace('.', '', $data['amount']) == '' ? 0 : str_replace('.', '', $data['amount'])) ;
        $lims_payment_data->change = ( str_replace('.', '', $data['paying_amount']) == '' ? 0 : str_replace('.', '', $data['paying_amount']) )  - ( str_replace('.', '', $data['amount']) == '' ? 0 : str_replace('.', '', $data['amount']) );
    ...
    public function updatePayment(Request $request)
    {
        ...
        $amount_dif = ( str_replace('.', '', $lims_payment_data->amount) == '' ? 0 : str_replace('.', '', $lims_payment_data->amount) ) - ( str_replace('.', '', $data['edit_amount']) == '' ? 0 : str_replace('.', '', $data['edit_amount']));
        $lims_purchase_data->paid_amount = ( str_replace('.', '', $lims_purchase_data->paid_amount) == '' ? 0 : str_replace('.', '', $lims_purchase_data->paid_amount)  ) - ( str_replace('.', '', $amount_dif) == '' ? 0 : str_replace('.', '', $amount_dif) );
        ...
        $lims_payment_data->account_id = $data['account_id'];
        $lims_payment_data->amount = ( str_replace('.', '', $data['edit_amount']) == '' ? 0 : str_replace('.', '', $data['edit_amount']) ) ;
        error_log("riki=========================");
        error_log($lims_payment_data->amount);
        $lims_payment_data->change = ( str_replace('.', '', $data['edit_paying_amount']) == '' ? 0 : str_replace('.', '', $data['edit_paying_amount']) )  - ( str_replace('.', '', $data['edit_amount']) == '' ? 0 : str_replace('.', '', $data['edit_amount']) );
        ...
        elseif ($data['edit_paid_by_id'] == 3){
            ...
            $token = $data['stripeToken'];
            $amount = ( str_replace('.', '', $data['edit_amount']) == '' ? 0 : str_replace('.', '', $data['edit_amount']) );
