...
class GiftCardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['expense'] = 0;
        $data['expense'] = (str_replace('.', '', $data['expense']) == '' ? 0 : str_replace('.', '', $data['expense']));
    ...
    public function update(Request $request, $id)
    {
        ...
        $lims_gift_card_data->amount = (str_replace('.', '', $data['amount_edit']) == '' ? 0 : str_replace('.', '', $data['amount_edit']));
