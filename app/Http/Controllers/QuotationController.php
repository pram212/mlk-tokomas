...
class QuotationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // error_log("riki aldi ");
        // error_log($data['total_discount']);
        // error_log($data['total_tax']);
        // error_log($data['total_price']);
        // error_log($data['grand_total']);
        // error_log($data['order_tax_rate']);
        // error_log($data['order_tax']);
        // error_log($data['order_discount']);
        // error_log($data['shipping_cost']);
        // error_log($data['paid_amount']);
